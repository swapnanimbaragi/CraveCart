...
public class MyDeliveriesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Order> myDeliveries = new ArrayList<Order>();
		myDeliveries.addAll(pickedOrders);
		myDeliveries.addAll(outForDeliveryOrders);

		req.setAttribute("myDeliveries", myDeliveries);

		req.getRequestDispatcher("/JSP/myDeliveries.jsp").forward(req, resp);
	}
}